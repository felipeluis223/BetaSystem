...
export default function HomeHeader() {
    ...
    return (
        <header className="w-full h-auto bg-[#040404] flex flex-row justify-between shadow-md relative z-50">
            <section className="w-[20%] h-[80px] flex items-center justify-center">
                <h3 className="font-bold text-white text-lg">Olá {nameMock}!</h3>
            </section>

            <nav className="w-[60%] h-[80px] flex items-center">
